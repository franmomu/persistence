...
use Doctrine\Tests\Persistence\Mapping\Fixtures\AnotherStdGlobal;
use Doctrine\Tests\Persistence\Mapping\Fixtures\StdGlobal;
...
class FileDriverTest extends DoctrineTestCase
{
    ...
    public function testGetElementFromGlobalFile(): void
    {
        ...
        $element = $driver->getElement(StdGlobal::class);

        self::assertSame(StdGlobal::class, $element->getName());
    }
    ...
    public function testGetAllClassNamesGlobalBasename(): void
    {
        ...
        self::assertSame([StdGlobal::class, AnotherStdGlobal::class], $classNames);
    }
    ...
    public function testGetAllClassNamesBothSources(): void
    {
        ...
        self::assertSame([StdGlobal::class, AnotherStdGlobal::class, stdClass::class], $classNames);
    }
    ...
    public function testIsNotTransient(): void
    {
        ...
        self::assertFalse($driver->isTransient(StdGlobal::class));
        self::assertFalse($driver->isTransient(AnotherStdGlobal::class));
    }
...
class TestFileDriver extends FileDriver
{
    ...
    protected function loadMappingFile($file)
    {
        if (strpos($file, 'global.yml') !== false) {
            return [
                StdGlobal::class => new TestClassMetadata(StdGlobal::class),
                AnotherStdGlobal::class => new TestClassMetadata(AnotherStdGlobal::class),
            ];
        }
